                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tr>
                                        ...
                                        <th>Number</th>
                                        <th><a href="" id = "is_baned" onclick="OrderByEnable();return false;"><i class="fa fa-sort"></i>без бана</a></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>${user.isEnabled()?string("true", "false")}</td>
                                        <td>${user.getRole()}</td>
                ...
                if (response_data.length > 0) {
                    ...
                    for (var i = 0; i < response_data.length; i++) {
                        $("#res").append("<tr><td>"+response_data[i].id +"</td><td>"+
                                ...
                                "</td><td>"+ response_data[i].username  +"</td><td>" +response_data[i].number +
                                "</td><td>"+response_data[i].enabled + "</td><td>" +
                                response_data[i].authorities[0].authority + "</td><td><a href='/edit_user/"+
                        response_data[i].id + "'><span class='fa fa-edit'></span></a></td></tr>");
                    }
                } else {
                    $("#res").html("");
                }
