                            ...
                            <table id="datatable-responsive"
                                ...
                                <tbody id="res">
                                    <#if drives??>
                                        ...
                                        <tr>
                                            <td>${drive.getName()}</td>
                                            <td>${drive.getNumber()}</td>
                                            <td>${drive.getDate()}</td>
                                            <td>${drive.getCar().getManufacture().getManufacture()}
                                                - ${drive.getCar().getModel().getModel()} -
                                            </td>
                                            <td>${drive.getCar().getModel().getMotor().getType()}</td>
                                            <td>${drive.getStatus().getStatus()}</td>
                                            <td><a href="/operator/edit_drive/${drive.getId()}"><span
