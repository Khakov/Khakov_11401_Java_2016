...
public class Checkers extends JFrame {
    ...
    private void captureQueen(int i, int j, int k, int n, boolean f1) {
    ...
    private void highlightChecker(int i, int j, int k, int n) {
    ...
    private void capturedChecker(int i, int j, int k, int n) {
